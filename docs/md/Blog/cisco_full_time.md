...
- Exams: April 17 to 30
- Final date for exam grades to be posted: May 19
- Can receive proof of graduation and official transcript in the following week
- If I do the language tests prior and have all necessary documentation. I can have the receipt of acknowledgement by the end of May and start in June

### How long does PGWP take and what are the requirements?
- have 180day (3months) to apply after I graduate
- takes 150-221days (5months-7months)
- can work after I graduate and applied for PGWP
- https://www.canada.ca/en/immigration-refugees-citizenship/services/study-canada/work/after-graduation/after-you-apply.html#working

### WHen can you start the earliest? Including PGWP >
- After applying for PGWP and got acknowledgement of receipt

### How do you resolve conflict in a team?

- listen to the other party. Weight in their argument, find a middle ground, vote or include a mediator. Concede

### Why do you want to work here?

- Debut my career in systems engineering. Cisco is reknown world wide in networking and in the cybersecurity space.
- Cisco allows the internet to function
- I want to be part of that mission of connecting everyone by creating software that solves problems.

### What is your greatest weakness?

- I can nerd snipped easily and can take tangents if I not careful. I overcome this by using keeping a queue or a todo list. When I get nerdsnipped, I evaluate if it is relevant to the work I am doing, if yes, I explore to get enough info else I pushed to my queue

### Tell me about yourself and highlight only relevant details to the job

- Upcoming software engineer
- Proficient in C and python
- I love resolving problems using software
- I am diligent and patient and focus hard on hard problems
...
- device used to route traffic from one network to another or subnet to another

### Network switch

- networking hardware that connects devices on a network using packet switching
- allowing them to send and receive data using their MAC addresses
...
- Packet switching method of transmitting data in `formatted units` portion.
- Each packet has a header and payload. size: ``
...
- translation of data between apps and devices e.g encoding, UTF8
...
- ipv6 removes the need for NAT (Network Address translation). -`Network Address Translation (NAT)` is a networking service that allows devices in a private network to communicate with devices in an external network, such as the internet, by translating their private IP addresses to a public IP address
...
### how have you integrated AI into your workflow
